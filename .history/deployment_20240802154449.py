...
def get_user_input():
    with st.sidebar:
        ...
        Province = st.selectbox("Province", (df_localize[df_localize["Region"] == Region]["Province"].unique()).sort_values())
        ...
        Locality = st.selectbox("Locality", (df_localize[df_localize["Province"] == Province]["Locality"].unique()).sort_values()

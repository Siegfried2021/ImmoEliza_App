    ...
    with st.sidebar:
        ...
        if TypeProperty == "Apartments":
            ...
            Property_display = {"Type Of Property": TypeProperty, "Region": Region, "Province": Province, "Locality": Locality,"Living area": LivingArea, "Number of bedrooms": BedroomCount, 
                                "Number of bathrooms": BathroomCount, "Garden": Garden, "Terrace": Terrace, "Swimming Pool": SwimmingPool, "Kitchen": KitchenType, "Year of construction": ConstructionYear, "State of the building": StateBuilding, "PEB": PEB}
